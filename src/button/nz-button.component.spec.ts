...
describe('NzButton', () => {
  ...
  describe('NzButton without disabled', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({imports: [NzButtonModule], declarations: [TestAppComponent], providers: []})
          .compileComponents();
    }));
  ...
  describe('NzButton with disabled', () => {
    beforeEach(async(() => {
      TestBed
          .configureTestingModule({imports: [NzButtonModule], declarations: [TestAppDisabledComponent], providers: []})
          .compileComponents();
    }));
  ...
  describe('NzButton with group', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({imports: [NzButtonModule], declarations: [TestAppGroupComponent], providers: []})
          .compileComponents();
    }));
  ...
  describe('NzButton with literal boolean attributes', () => {
    beforeEach(async(() => {
      TestBed
          .configureTestingModule({imports: [NzButtonModule], declarations: [TestAppLiteralComponent], providers: []})
          .compileComponents();
    }));
...
class TestAppComponent {
  ...
  clickButton = (value) => {
    this.isLoading = true;
    setTimeout(_ => { this.isLoading = false; }, 5000);
  }
}
