  ...
  beforeEach(async(() => {
    TestBed
        .configureTestingModule({
          ...
          declarations: [
            GridListWithoutColsComponent, GridListWithoutRowsComponent, TestSpanComponent, TestOffsetComponent,
            TestPushPullComponent, TestColResponsiveComponent, TestGutterComponent, TestTypeFlexComponent,
            TestTypeFlexOrderComponent, TestTypeEmbeddedComponent
          ]
        })
        .compileComponents();
  }));
