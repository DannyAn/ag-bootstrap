...
export class NzTooltipDirective implements AfterViewInit {
  ...
  constructor(
      public elementRef: ElementRef, private hostView: ViewContainerRef, private resolver: ComponentFactoryResolver,
      private renderer: Renderer2, @Optional() tooltip: NzToolTipComponent) {
