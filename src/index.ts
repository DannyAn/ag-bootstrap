...
export {NgbCalendar, NgbCalendarIslamicCivil, NgbCalendarIslamicUmalqura, NgbDateAdapter, NgbDateParserFormatter, NgbDatepicker, NgbDatepickerConfig, NgbDatepickerI18n, NgbDatepickerModule, NgbDateStruct, NgbInputDatepicker} from './datepicker/datepicker.module';
export {NgbDropdown, NgbDropdownConfig, NgbDropdownModule} from './dropdown/dropdown.module';
export {ModalDismissReasons, NgbActiveModal, NgbModal, NgbModalModule, NgbModalOptions, NgbModalRef} from './modal/modal.module';
...
@NgModule({
  imports: [
    ...
    NzTransferModule.forRoot(),     BrowserAnimationsModule
  ],
  exports: NGB_MODULES
})
