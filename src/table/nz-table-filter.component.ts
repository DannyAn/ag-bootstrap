...
import {NzDropDownComponent} from '../nzdropdown/nz-dropdown.component';
@Component({
  selector: '[nz-table-filter]',
  template: `
    <a href="javascript:void()" class="ant-table-filter-dropdown-link confirm" (click)="hideDropDown()">
      <ng-content select="[nz-table-filter-confirm]"></ng-content>
    </a>
    <a href="javascript:void()" class="ant-table-filter-dropdown-link clear" (click)="hideDropDown()">
