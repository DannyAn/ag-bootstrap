...
describe('NzPaginationComponent', () => {
  beforeEach(async(() => {
    TestBed
        .configureTestingModule({
          ...
          declarations: [
            TestPaginationBasicComponent, TestPaginationChangerComponent, TestPaginationSimpleComponent,
            TestPaginationShowTotalComponent
          ],
          providers: []
        })
        .compileComponents();
  ...
  describe('for nz-pagination', () => {
    it('the correct pages are displayed and the previous page is disabled or not disabled', () => {
      ...
      expect(
          debugElement.nativeElement.querySelector('.ant-pagination-prev')
      ...
      fixture.detectChanges();
      expect(
          debugElement.nativeElement.querySelector('.ant-pagination-next')
              .classList.contains('ant-pagination-item-active'))
          .toBe(false);
      expect(
          debugElement.nativeElement.querySelector('.ant-pagination-next')
      ...
      fixture.detectChanges();
      expect(
          debugElement.nativeElement.querySelector('.ant-pagination-item:nth-child(4)')
              .classList.contains('ant-pagination-item-active'))
          .toBe(true);
      expect(
          debugElement.nativeElement.querySelector('.ant-pagination-prev')
    ...
    it('simply flip the page', () => {
      ...
      const debugElement = fixture.debugElement.query(By.directive(NzPaginationComponent));
      fixture.detectChanges();
      expect(debugElement.nativeElement.querySelector('.ant-pagination').classList.contains('ant-pagination-simple'))
          .toBe(true);
    });
    ...
    it('correct disabled style when reach first and last pageIndex', () => {
      ...
      const debugElement = fixture.debugElement.query(By.directive(NzPaginationComponent));
      fixture.detectChanges();
      expect(debugElement.nativeElement.querySelector('.ant-pagination-prev').className)
          .toEqual('ant-pagination-prev ant-pagination-disabled');
      testComponent.pageSize = 4;
      fixture.detectChanges();
      expect(debugElement.nativeElement.querySelector('.ant-pagination-next').className)
          .toEqual('ant-pagination-next ant-pagination-disabled');
    });
  });
